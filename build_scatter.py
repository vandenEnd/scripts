...
def _clean_var_label(label):
    ...
    the ", ABOVE MEDIAN dummy" suffix from a regression spec's label,
...
# shock-year interaction, above-median dummy + interaction), estimating
...
logit_spec_groups = [
    ...
    ("Above-median dummy + interaction", above_median_specs, "above_x_shock"),
]
...
table_display_names = [
    ...
    ("AI incoming investment share", "AI investment patents"),
...
note_lines = [
    ...
    "(3) OLS, above-median dummy + interaction: same as (2), but X is replaced "
    "by a binary above/below-median indicator; gamma is that indicator's "
    "additional effect during shock years.",
    ...
    "(6) LOGIT, above-median dummy + interaction: logit counterpart of (3).",
]
