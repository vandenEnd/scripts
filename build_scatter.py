...
model_estimator = {
    1: "Logit", 2: "Logit", 3: "Logit", 4: "OLS", 5: "OLS", 6: "OLS",
}
model_coef_kind = {
...
note_lines = [
    ...
    "(1) LOGIT, plain X: same specification as (4), but P(growth_surprise > 0) "
    ...
    "(2) LOGIT, X + shock-year interaction: logit counterpart of (5).",
    "(3) LOGIT, above-median value + interaction: logit counterpart of (6).",
    # Explains the Driscoll-Kraay standard errors used in models (4),
    # (5), and (6) (the OLS specifications, now in the LATTER three
    # columns since Logit/OLS swapped column order) -- split across
    ...
    "     expected). Models (1)-(3) (logit) still use the analytic-Hessian standard "
    ...
    "For LOGIT (models 1-3): the SAME one-standard-deviation-increase framing "
    "applies to the underlying index (X*beta), but NOT directly to the predicted "
    "PROBABILITY of a positive surprise -- because of the logistic link function,",
    ...
    "on probability varies along the logistic curve, largest near p=0.5 and",
