...
* Python/pandas/statsmodels/linearmodels pipeline. It has NOT been run
* start-to-finish in Stata by me (Stata is not available in the environment
* this was written in) -- treat this as a carefully checked draft, not a
* guaranteed-correct final version. Run it, and if/where it errors, report
* the exact error back for a fix, the same way the Python version was
* iteratively debugged over many rounds.
*=============================================================================
