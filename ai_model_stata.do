...
tempfile shock_innov_dta
save `shock_innov_dta'
...
program define build_panel
    ...
    * merge in the AR-purified shock (entity-invariant, merges on quarter)
    merge m:1 quarter using `shock_innov_dta', keep(master match) nogenerate
