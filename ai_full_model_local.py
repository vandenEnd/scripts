...
SCRIPT_VERSION = "2025-08-11-v41-time-trend-control"  # bump this whenever the file changes;
...
SHOCK_VARIABLE = "GPR"          # "WUI", "GPR", "EPU", "TPU", or "GSCPI" --
...
if __name__ == "__main__":
    ...
    7. ALL THREE IRF CHARTS (baseline, ICT, Corr) are rescaled to show
       ...
       ratio unchanged).
    8. ALL THREE specs now also include an explicit LINEAR TIME TREND
